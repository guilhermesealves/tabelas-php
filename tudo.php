...
<body>
    ...
    <div class="tudo-meio">
        <div class="meio">
            ...
            <div class="button-margin">
                <a href="cadastroProdutos.php"><button>Cadastro Produtos</button></a>
            </div>
            <div class="button-margin">
                <a href="cadastroFuncionario.php"><button>Cadastro Funcionario</button></a>
            </div>
            <div class="button-margin">
                <a href="cadastroFornecedor.php"><button>Cadastro Fornecedor</button></a>
            </div>
    ...
    <div class="main">
        <div class="up">
            <a href="https://www.instagram.com/guiseleri/">
            <button class="card1">
        ...
        <div class="down">
            <a href="https://github.com/guilhermesealves">
                <button class="card3">
